...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Paradox.Modding.Core\functions", "$global:testroot\..\Paradox.Modding.Core\internal\functions"),
	
	[string]
	$ModuleName = "Paradox.Modding.Core",
...
$CommandPath = @(
    "$global:testroot\..\Paradox.Modding.Core\functions"
    "$global:testroot\..\Paradox.Modding.Core\internal\functions"
)
