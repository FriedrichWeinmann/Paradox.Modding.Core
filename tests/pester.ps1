...
Remove-Module Paradox.Modding.Core -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Paradox.Modding.Core\Paradox.Modding.Core.psd1"
Import-Module "$PSScriptRoot\..\Paradox.Modding.Core\Paradox.Modding.Core.psm1" -Force
